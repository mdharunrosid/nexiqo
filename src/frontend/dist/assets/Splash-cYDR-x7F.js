import { u as useRouter, r as reactExports, j as jsxRuntimeExports, m as motion } from "./index-BPdZgswX.js";
function SplashPage() {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        role: "presentation",
        style: {
          background: "linear-gradient(160deg, #0D1B2A 0%, #120B2E 35%, #1A0533 65%, #0D0D0D 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": "true", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                style: {
                  background: "radial-gradient(circle, oklch(0.65 0.18 240 / 0.35) 0%, transparent 70%)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                style: {
                  background: "radial-gradient(circle, oklch(0.5 0.2 290 / 0.3) 0%, transparent 70%)"
                }
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center gap-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                  ...
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "svg",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Nexiqo" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "path",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "22", cy: "22", r: "4", fill: "white" })
                        ]
                      }
                    )
                  }
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.p,
                    {
                      ...
                      children: "Create • Connect • Go Viral"
                    }
                  )
                ]
              }
